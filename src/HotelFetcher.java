...
public class HotelFetcher {
    ...
    /**
     * Fetches hotels using Yelp API.
     * @param cityName Name of the city you want hotels for.
     */
    public void searchHotels(String cityName) {
        try {
            String encodedCityName = URLEncoder.encode(cityName, "UTF-8");
            String apiUrl = baseUrl + "?location=" + encodedCityName + "&categories=hotels&sort_by=rating&limit=10";
            ...
            for (JsonElement businessElement : businesses) {
                ...
                System.out.println(hotelName + " - Rating: " + rating + " - Address: " + address);
            }
        } catch (Exception e) {
